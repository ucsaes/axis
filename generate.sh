...
export XCODEGEN_AXIS_CODE_SIGN_IDENTITY="axis-codesign-certificate"
...
while test $# -gt 0; do
    case $1 in
        ...
        --codesign-identity) XCODEGEN_AXIS_CODE_SIGN_IDENTITY="$2"; shift 2 ;;
...
public let axisAppVersion = "$build_version"
EOF
...
if test $generate_xcodeproj = 1; then
    export XCODEGEN_AXIS_VERSION=$build_version
