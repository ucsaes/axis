...
let move_node_to_workspace_help_generated = """
    ...
    """
let move_to_center_help_generated = """
    USAGE: move-to-center [-h|--help] [--window-id <window-id>]
    """
...
let move_help_generated = """
    ...
    """
let nav_help_generated = """
    USAGE: nav [-h|--help] [--window-id <window-id>] [--carry] (left|down|up|right)
    """
