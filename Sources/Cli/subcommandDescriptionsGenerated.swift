...
let subcommandDescriptions = [
    ...
    ["  config", "Query Axis config options"],
    ...
    ["  subscribe", "Subscribe to Axis events and receive notifications via socket"],
    ...
    ["  trigger-binding", "Trigger Axis binding as if it was pressed by user"],
